    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unp', models.CharField(default='УНП123456789', max_length=15, unique=True, verbose_name='УНП')),
                ('bank_name', models.CharField(default='Название банка', max_length=32, verbose_name='Название банка')),
