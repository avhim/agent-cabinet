...
class TourDescriptionDay(models.Model):
    tour = models.ForeignKey(Tour, default=None, on_delete=models.CASCADE, verbose_name="Тур", related_name='tour_description_day')
...
class TourDayQuota(models.Model):
    tour = models.ForeignKey(Tour, default=None, on_delete=models.CASCADE, verbose_name="Тур", related_name='tour_day_quota')
...
class CategoryTour(models.Model):
    ...
    img = models.ImageField(upload_to="tours/categoty", null=True, blank=True)
